...
<div class="tab-content">
    <form class="" action="{{ route('merchandise.update',['id' => $merchandise->id ]) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" value="{{ $merchandise->order }}" name="order" class="form-control" placeholder="Order" required>
        </div>
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input id="thumbnail" class="form-control" type="text" name="image" value="{{ $merchandise->image }}" required>
            </div>
