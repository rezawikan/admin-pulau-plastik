      ...
      <div class="tab-pane fade show active" id="{{ $value }}" role="tabpanel" aria-labelledby="{{ $value }}-tab">
          <div class="container">
              <div class="form-group">
                  ...
                  <input type="text" value="{{ $merchandise->translate($value)->title ?? null }}" name="{{ $value }}_title" class="form-control" id="{{ $value }}-title" placeholder="Title">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <textarea type="text" name="{{ $value }}_content" class="form-control text-editor" id="{{ $value }}-content" placeholder="Content" >{{ $merchandise->translate($value)->content ?? null }}</textarea>
              </div>
          </div>
      </div>
      @endforeach
